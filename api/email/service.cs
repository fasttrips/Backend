        ...
        private String SubmitMessage(string id)
        {
            return $@"
                <div style='font-size:14px; font-family:Arial, sans-serif; color:#434343; line-height:1.5;'>
                    ...
                    <p><a href='https://Trasgo-main-service-158474999909.asia-southeast2.run.app/api/v1/auth/activation/{id}' style='color:#1a73e8; text-decoration:none;'>Activate Your Account</a></p>
                    <p>If you did not request this activation, you can ignore this email.</p>
                    <p>Best regards,<br>Trasgo Team</p>
                </div>";
        }
